function UnityProgress (dom) {
	...
	logoImage.src = "built/TemplateData/Logo." + splashStyle + ".png"; 
	logoImage.style.position = "absolute";
	parent.appendChild(logoImage);
	this.logoImage = logoImage;

	var progressFrame = document.createElement("img");
	progressFrame.src = "built/TemplateData/ProgressFrame." + splashStyle + ".png"; 
	...
	progressBarImg.src = "built/TemplateData/ProgressBar." + splashStyle + ".png"; 
